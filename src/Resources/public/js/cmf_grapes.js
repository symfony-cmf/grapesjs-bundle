...
var _cmf_grapes_adapter = __webpack_require__(1);

var _cmf_grapes_adapter2 = _interopRequireDefault(_cmf_grapes_adapter);
...
jQuery.fn.cmfGrapes = function (options) {
  ...
  if (!options.adapter) {
    options.adapter = new _cmf_grapes_adapter2.default(options);
  }
